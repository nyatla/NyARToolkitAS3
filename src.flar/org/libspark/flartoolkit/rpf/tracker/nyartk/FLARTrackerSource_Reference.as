package org.libspark.flartoolkit.rpf.tracker.nyartk
{
	...
	public class FLARTrackerSource_Reference extends NyARTrackerSource
	{
		 ...
		 */
		public function FLARTrackerSource_Reference(i_number_of_sample:int, i_ref_raster_distortion:INyARCameraDistortionFactor, i_width:int, i_height:int, i_depth:int, i_is_alloc:Boolean)
		{

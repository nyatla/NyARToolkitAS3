 ...
 * 
 */
package jp.nyatla.nyartoolkit.as3.psarplaycard{

	import jp.nyatla.nyartoolkit.as3.core.NyARException;
	import jp.nyatla.nyartoolkit.as3.core.pixeldriver.INyARGsPixelDriver;
	...
	public class PsARPlayCardPickup
	{
		 ...
		 * @throws NyARException
		 */
		public function getARPlayCardId(i_pix_drv:INyARGsPixelDriver,i_vertex:Vector.<NyARIntPoint2d>,i_result:PsARPlayCardPickup_PsArIdParam):Boolean
		{
		 ...
		 * @throws NyARException
		 */
		public function getARPlayCardId_2(i_pix_drv:INyARGsPixelDriver,i_vertex:Vector.<NyARDoublePoint2d>,i_result:PsARPlayCardPickup_PsArIdParam):Boolean
		{
		 ...
		 * @throws NyARException
		 */
		private function _pickFromRaster(i_pix_drv:INyARGsPixelDriver,i_result:PsARPlayCardPickup_PsArIdParam):Boolean
		{
...
class PerspectivePixelReader
{
	 ...
	 * @throws NyARException
	 */
	public function readDataBits(i_reader:INyARGsPixelDriver,i_raster_size:NyARIntSize,o_bitbuffer:MarkerPattDecoder):Boolean
	{

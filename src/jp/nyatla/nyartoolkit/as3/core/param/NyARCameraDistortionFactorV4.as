...
package jp.nyatla.nyartoolkit.as3.core.param 
{
	...
	{	
		...
		private function getSizeFactor(x0:Number,y0:Number, xsize:int,ysize:int):Number
		{
			...
			oy = y0;
			olen = x0;
			var itmp:NyARDoublePoint2d=new NyARDoublePoint2d();
		...
		{
			var src:NyARCameraDistortionFactorV4=NyARCameraDistortionFactorV4(i_ref);
			this._k1=src._k1;
			this._k2=src._k2;
			this._p1=src._p1;
			this._p2=src._p2;
		 ...
		 */
		public function setValue_2(i_size:NyARIntSize,i_intrinsic_matrix:Vector.<Number>,i_distortion_coeffs:Vector.<Number>):void
		{
